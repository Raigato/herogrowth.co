 ...
 */
require_once SEIL_FRAMEWORK . '/plugins/notify/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'seil_register_required_plugins' );
 ...
 */
function seil_register_required_plugins() {
	/*
    ...
    array(
	    'name'					=> 'Seil Core',
	    'slug'     			=> 'seil-core',
	    'source'				=> 'http://victorthemes.com/plugins/seil-core.zip',
	    'required'			=> true,
