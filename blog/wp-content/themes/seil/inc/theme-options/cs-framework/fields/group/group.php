...
class CSFramework_Option_group extends CSFramework_Options {
  ...
  public function output() {
    ...
    $acc_title   = ( isset( $this->field['accordion_title'] ) ) ? $this->field['accordion_title'] : __( 'Adding', 'seil' );
    ...
    echo '<div class="cs-group cs-group-'. $el_class .'-adding hidden">';
      ...
      echo '<div class="cs-element cs-text-right cs-remove"><a href="#" class="button cs-warning-primary cs-remove-group">'. __( 'Remove', 'seil' ) .'</a></div>';
      echo '</div>';
