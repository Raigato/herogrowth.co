...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        /**
         * Seil the condition of this rule in given jQuery context.
         *
         * The widget value is extracted using getControlValue()
         *
         * @param {jQuery} context The jQuery selection in which this rule is seild.
         *
         */
         ...
         * @param  {Object} enforced Recursive rule enforcer: undefined to seil condition, true show always, false hide always
         *
         */
